...
vi.mock('svgin-core/fetchAndSanitizeSvgServer', () => ({
    fetchAndSanitizeSvg: vi.fn(),
}));
vi.mock('svgin-core/sanitizeSvgStringServer', () => ({
    sanitizeSvgString: vi.fn(),
}));

import { SvgIn } from './SvgIn.server';
import { fetchAndSanitizeSvg } from 'svgin-core/fetchAndSanitizeSvgServer';
import { sanitizeSvgString } from 'svgin-core/sanitizeSvgStringServer';
