...
> **Status:** placeholder stub. Real `<svg-in>` behavior lands in a later PR. **Update this README (and
> any docs-site page) in the same PR/build whenever `<svg-in>`'s public API or behavior changes** — see
> the `svgin-monorepo` skill.
