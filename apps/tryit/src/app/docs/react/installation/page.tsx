...
export const metadata = pageMetadata({
    title: '@svgin/react: Installation',
    description:
...
export default function ReactInstallationPage() {
    return (
        <article className="space-y-6">
            <h1 className="text-2xl font-semibold tracking-tight">@svgin/react: Installation</h1>
            ...
            <div>
                ...
                <p className="mt-2 text-sm text-muted-foreground">
                    ...
                    in the <Link className="underline underline-offset-4 hover:text-foreground" href="/docs/react/api">API reference</Link>.
                </p>
